      ...
      <form className="relative my-4" onSubmit={subscribe}>
        ...
        <div className="inline-flex rounded-md shadow-sm my-2" role="group">
          ...
          <button
            ...
            py-2 px-4 text-sm font-medium   rounded-r-md border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:border-gray-600 dark:text-white dark:hover:text-white  dark:focus:ring-blue-500 dark:focus:text-white`}
          >
            Developer
          </button>
        </div>
